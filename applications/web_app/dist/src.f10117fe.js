...
},{"./utils":"node_modules/axios/lib/utils.js","./helpers/normalizeHeaderName":"node_modules/axios/lib/helpers/normalizeHeaderName.js","./adapters/xhr":"node_modules/axios/lib/adapters/xhr.js","./adapters/http":"node_modules/axios/lib/adapters/xhr.js","process":"C:/Users/lampi/AppData/Roaming/npm/node_modules/parcel-bundler/node_modules/process/browser.js"}],"node_modules/axios/lib/core/dispatchRequest.js":[function(require,module,exports) {
'use strict';
...
},{"./lib/axios":"node_modules/axios/lib/axios.js"}],"src/base/Eventing.ts":[function(require,module,exports) {
"use strict";
...
var Eventing = function Eventing() {
  ...
  this.events = {}; // events is an object with key-property of Callback[]
...
},{}],"src/base/Collection.ts":[function(require,module,exports) {
"use strict";
...
},{"axios":"node_modules/axios/index.js","./Eventing":"src/base/Eventing.ts"}],"src/base/Model.ts":[function(require,module,exports) {
"use strict";
...
var Model = /*#__PURE__*/function () {
  function Model(attributes, events, sync) {
    ...
    this.events = events;
    this.sync = sync; //refactor invoking methods in other classes (events, sync, attributes)
    // get on() {
  ...
  _createClass(Model, [{
    ...
    value: function fetch() {
      ...
      this.sync.fetch(id).then(function (response) {
        _this.set(response.data); //by using this.set instead of this.attributes.save we will also trigger a change-event
...
exports.Model = Model;
},{}],"src/models/user/UserAttributes.ts":[function(require,module,exports) {
"use strict";
...
var UserAttributes = /*#__PURE__*/function () {
  ...
  _createClass(UserAttributes, [{
    key: "set",
    value: function set(updateObject) {
...
},{}],"src/models/user/ApiSync.ts":[function(require,module,exports) {
"use strict";
...
var ApiSync = /*#__PURE__*/function () {
  ...
  _createClass(ApiSync, [{
    ...
    value: function save(data) {
      var id = data.id; //NOTE: or we can type const { id } = data;
...
},{"axios":"node_modules/axios/index.js"}],"src/models/user/User.ts":[function(require,module,exports) {
"use strict";
...
var Eventing_1 = require("../../base/Eventing");

var ApiSync_1 = require("./ApiSync");

var Collection_1 = require("../../base/Collection");
...
var User = /*#__PURE__*/function (_Model_1$Model) {
  ...
  _createClass(User, [{
    ...
    value: function BuildUser(attrs) {
      return new User(new UserAttributes_1.UserAttributes(attrs), new Eventing_1.Eventing(), new ApiSync_1.ApiSync(rootUrl));
    }
  }, {
...
exports.User = User;
},{"../../base/Model":"src/base/Model.ts","./UserAttributes":"src/models/user/UserAttributes.ts","../../base/Eventing":"src/base/Eventing.ts","./ApiSync":"src/models/user/ApiSync.ts","../../base/Collection":"src/base/Collection.ts"}],"src/views/CollectionView.ts":[function(require,module,exports) {
"use strict";
    ...
    value: function bindEvents(fragment) {
      ...
      var _loop = function _loop(eventKey) {
        var _eventKey$split = eventKey.split(':'),
            ...
            selector = _eventKey$split2[1]; //get array of elements that match that selector
...
users.fetch();
},{"./base/Collection":"src/base/Collection.ts","./models/user/User":"src/models/user/User.ts","./views/UserList":"src/views/UserList.ts"}],"C:/Users/lampi/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["C:/Users/lampi/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","src/index.ts"], null)
